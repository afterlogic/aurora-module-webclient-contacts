      ...
      <div class="items_list">
        ...
        <div class="item canSelect" data-bind="visible: showSharedToAllContacts, 
          ...
          <span class="title" data-bind="
              ...
              droppable: {valueFunc: function (oEvent, oUi) { $root.contactsDropToGroupType('shared', oEvent, oUi); }, switchObserv: disableDropToSharedWithAll},
        ...
        <!-- ko foreach: addressBooks -->
          <div class="item canSelect" data-bind="
            ...
            <span class="title" data-bind="click: function () { $parent.changeGroupType(Id); }, css: {'recivedAnim': $parent.recivedAnimTeam()}">
              <span class="name fadeout">
                <span class="icon type1"></span>
